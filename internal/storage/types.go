...
type Node struct {
	...
	ImpersonateDeviceName   string `json:"impersonateDeviceName,omitempty"`
...
type packedNode struct {
	...
	ImpersonateDeviceName   string `json:"idn,omitempty"`
}
...
func PackNode(node Node) (string, error) {
	...
	if node.ImpersonateDeviceName != "" {
		p.ImpersonateDeviceName = node.ImpersonateDeviceName
	}
...
func UnpackNode(name, packed string) (Node, bool) {
	...
	return Node{
		...
		ImpersonateDeviceName:   p.ImpersonateDeviceName,
	}, true
}
